...
"""
import os, re, json, shutil, logging, subprocess, sys
from datetime import datetime
from typing import Optional

_PYTHON_EXE = sys.executable or "python3"
...
def start_bot(bot_id: str) -> tuple:
    ...
    try:
        ...
        proc = subprocess.Popen([_PYTHON_EXE, "-u", "bot.py"], cwd=folder, stdout=lf, stderr=lf, text=True)
